...
(if (string= system-type "windows-nt")
    (load "D:/Program Files/MATLAB/R2007b/java/extern/EmacsLink/lisp/matlab.el" nil t t)
  (load "matlab.el" nil t t))
...
(defun matlab-insert-function-hyperlink ()
  ...
  (interactive)
  (setq myFunctionName (read-from-minibuffer  "FunctionName: "))
